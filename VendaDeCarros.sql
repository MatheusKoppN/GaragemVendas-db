-- 1. CONFIGURAÇÃO DE PERFIS (ROLES)
-- Essencial para demonstrar controle de acesso no portfólio [1, 2]
DO $$ 
BEGIN
...
-- 2. DEFINIÇÃO DA ESTRUTURA (DDL) [3-9]
...
-- 3. POVOAMENTO DE DADOS (DML) [10-13]
...
INSERT INTO funcionarios (nome, id_gerente) VALUES ('Matheus Kopp', NULL); -- Gerente Geral [14]
INSERT INTO funcionarios (nome, id_gerente) VALUES ('Thiago Mendes', 1), ('Beatriz Silva', 1);

-- Cadastro de 20 Carros: 10 Vendidos (Status 2) e 10 Disponíveis (Status 1)
INSERT INTO carros (modelo, ano, preco, id_marca, id_status) VALUES 
('Civic', 2022, 130000, 1, 2), ('Corolla', 2023, 145000, 2, 2), ('Mustang', 2021, 320000, 3, 2),
('Golf', 2020, 180000, 4, 2), ('C180', 2021, 185000, 5, 2), ('320i', 2023, 290000, 6, 2),
('A3', 2020, 145000, 7, 2), ('Uno', 2015, 35000, 8, 2), ('Onix', 2023, 85000, 9, 2),
('HB20', 2024, 92000, 2, 2), -- Fim dos carros vendidos
('Compass', 2022, 180000, 3, 1), ('Kicks', 2023, 115000, 1, 1), ('XC60', 2021, 350000, 6, 1), 
('Cruze', 2022, 125000, 9, 1), ('Creta', 2023, 140000, 2, 1), ('Renegade', 2021, 105000, 3, 1), 
('Sentra', 2024, 155000, 1, 1), ('GLA 200', 2023, 295000, 5, 1), ('911 Carrera', 2024, 950000, 6, 1), 
('Range Rover', 2023, 380000, 7, 1);

-- Registro das 10 Vendas correspondentes aos 10 primeiros carros [13]
...
-- 4. AUTOMAÇÕES (FUNCTIONS E TRIGGERS) [15, 16]
